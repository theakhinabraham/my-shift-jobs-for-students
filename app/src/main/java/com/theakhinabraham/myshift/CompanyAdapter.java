...
public class CompanyAdapter extends FirestoreRecyclerAdapter<Job, CompanyAdapter.MyViewHolder> {

    public CompanyAdapter(@NonNull FirestoreRecyclerOptions<Job> options) {
        super(options);
    }
